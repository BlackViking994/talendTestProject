...
package local_project.tmapstates_0_1;
...
/**
 * Job: tMapStates Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class tMapStates implements TalendJob {
	...
	private final String jobName = "tMapStates";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tMapStates.this, new Object[] { e,
	...
	public static class ResultStruct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_tMapStates = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_tMapStates = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_tMapStates.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_tMapStates.length == 0) {
						commonByteArray_LOCAL_PROJECT_tMapStates = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_tMapStates = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_tMapStates, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_tMapStates, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_tMapStates) {
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.stateAbbr, dos);
	...
	public static class row1Struct implements
		...
		public String toString() {
			...
			sb.append(",SateID=" + String.valueOf(SateID));
			sb.append("]");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("Result" + iterateId, 0,
								0);
				...
				try {
					filename_tFileInputXML_1 = "/Users/milossundic/Desktop/data.xml";
				...
				if (isValidFile_tFileInputXML_1) {
					...
					org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1
							.createXPath(nsTool_tFileInputXML_1
									.addDefaultNSPrefix("/records/record"));
					x_tFileInputXML_1
					...
					for (org.dom4j.tree.AbstractNode temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						if (nb_line_tFileInputXML_1 >= 100) {
						...
						try {
							...
							if (xml_api_tFileInputXML_1
								...
								row1.Email = str_tFileInputXML_1;
							}
							...
							Object obj4_tFileInputXML_1 = xpaths_tFileInputXML_1
									.get(4).evaluate(temp_tFileInputXML_1);
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'Result'
								Result_tmp.Name = row1.Name;
								Result_tmp.state = row2.state;
								Result_tmp.stateAbbr = row2.stateAbbr;
								Result = Result_tmp;
								// ###############################
							...
							if (Result != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection("Result"
											+ iterateId, 1, 1);
								}
								...
								if (Result.state != null) { //
									row_tLogRow_1[1] = String
											.valueOf(Result.state);

								} //

								if (Result.stateAbbr != null) { //
									row_tLogRow_1[2] = String
											.valueOf(Result.stateAbbr);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null
							|| !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("Result" + iterateId, 2,
								0);
					}
				}
	...
	public static class row2Struct implements
		...
		public void copyDataTo(row2Struct other) {
			...
			other.stateAbbr = this.stateAbbr;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.stateAbbr = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.stateAbbr, dos, oos);
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(after_tFileInputXML_1) outputs:(row2,row2) | target
				// node:tAdvancedHash_row2 - inputs:(row2) outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(Result)
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/Users/milossundic/Desktop/States.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/Users/milossundic/Desktop/States.csv",
								"US-ASCII", ",", "\n", false, 1, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row2.state = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row2.stateAbbr = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row2 != null) {
							...
							row2_HashRow.stateAbbr = row2.stateAbbr;
					...
					if (!((Object) ("/Users/milossundic/Desktop/States.csv") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final tMapStates tMapStatesClass = new tMapStates();

		int exitCode = tMapStatesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tMapStates.class.getClassLoader()
					.getResourceAsStream(
							"local_project/tmapstates_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = tMapStates.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : tMapStates");
		}
...
/************************************************************************************************
 * 81100 characters generated by Talend Open Studio for ESB on the May 31, 2018
 * 1:43:28 AM CEST
 ************************************************************************************************/
