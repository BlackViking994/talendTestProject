...
package local_project.xmldelimiter_0_1;
...
/**
 * Job: xmlDelimiter Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class xmlDelimiter implements TalendJob {
	...
	private final String jobName = "xmlDelimiter";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(xmlDelimiter.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_xmlDelimiter = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_xmlDelimiter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_xmlDelimiter.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_xmlDelimiter.length == 0) {
						commonByteArray_LOCAL_PROJECT_xmlDelimiter = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_xmlDelimiter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_xmlDelimiter, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_xmlDelimiter, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_xmlDelimiter) {
				...
				if (isValidFile_tFileInputXML_1) {
					...
					for (org.dom4j.tree.AbstractNode temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						...
						if (row1 != null) {
							...
							if (row1.Email != null) { //
								row_tLogRow_1[2] = String.valueOf(row1.Email);

							} //

							if (row1.Country != null) { //
								row_tLogRow_1[3] = String.valueOf(row1.Country);
	...
	public static void main(String[] args) {
		final xmlDelimiter xmlDelimiterClass = new xmlDelimiter();

		int exitCode = xmlDelimiterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = xmlDelimiter.class.getClassLoader()
					.getResourceAsStream(
							"local_project/xmldelimiter_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = xmlDelimiter.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : xmlDelimiter");
		}
...
/************************************************************************************************
 * 51001 characters generated by Talend Open Studio for ESB on the May 31, 2018
 * 12:57:24 AM CEST
 ************************************************************************************************/
