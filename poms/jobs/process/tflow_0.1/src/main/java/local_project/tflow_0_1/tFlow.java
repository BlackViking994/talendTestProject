...
package local_project.tflow_0_1;
...
/**
 * Job: tFlow Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class tFlow implements TalendJob {
	...
	private final String jobName = "tFlow";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tFlow.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_tFlow = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_tFlow = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_tFlow.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_tFlow.length == 0) {
						commonByteArray_LOCAL_PROJECT_tFlow = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_tFlow = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_tFlow, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_tFlow, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_tFlow) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				result_tFixedFlowInput_1
						.append("MTtNaWxvcztTdW5kaWMKMjtNYXJrbztNYXJrb3ZpYwozO1BldGFyO1BldHJvdmlj");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						if (0 < fid_tFixedFlowInput_1
							...
							row1.ID = (colContent == null || colContent
						...
						if (1 < fid_tFixedFlowInput_1
							...
							row1.firstName = (colContent == null || colContent
									.length() == 0) ? null : colContent;
						} else {
	...
	public static void main(String[] args) {
		final tFlow tFlowClass = new tFlow();

		int exitCode = tFlowClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tFlow.class.getClassLoader()
					.getResourceAsStream(
							"local_project/tflow_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = tFlow.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : tFlow");
		}
...
/************************************************************************************************
 * 32723 characters generated by Talend Open Studio for ESB on the May 31, 2018
 * 1:11:05 AM CEST
 ************************************************************************************************/
